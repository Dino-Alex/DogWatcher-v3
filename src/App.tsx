...
const SellPageRun = lazy(() => import('./views/Inventory/components/SellPage'))
      ...
      <Menu>
        <SuspenseWithChunkError fallback={<PageLoader />}>
          <Switch>
            ...
            <Route exact strict path="/investtogether" component={ComingSoon} />
            <Route exact strict path="/proposals" component={Proposals} />
            <Route exact strict path="/makeaproposals" component={MakeAProposals} />
            ...
            <Route exact path="/vote/:votingId" component={ComingSoon} />
            <Route exact path="/sign-up" component={Register}/>
            <Route exact path="/detailssell/:boxid" component={SellPageRun} />
            <Route exact path="/detailbuy/:saleId" component={BuyPage} />
            {/* <Route path="/">
              <Inventory />
            </Route> */}
