...
const CardFooter: React.FC<CardFooterProps> = ({link, locations, totalProfitAmount}) => {
                ...
                <Flex width="100%" flexDirection="column" mt="1.25rem" alignItems="end" justifyContent="flex-end">
                    <Flex flexDirection='column' width='100%'>
                        <Flex mb='10px'>
                            ...
                            <CsText width='60%' textAlign='end'>{locations}</CsText>
                        </Flex>
                        <Flex>
                            <CsText textTransform="uppercase" color="#B2B3BD" width='40%'>Last month's revenue:</CsText>
                            <CsText width='60%' textAlign='end'>{totalProfitAmount.toLocaleString('en', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</CsText>
                        </Flex>
                    </Flex>
