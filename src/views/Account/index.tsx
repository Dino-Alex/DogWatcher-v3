    ...
    <PageFullWidth>
      ...
      <CustomContainer1>
        <Row>
          ...
          <Col>
            {/* <TextTitle>Your Avatar</TextTitle>
                    <Flex >
                      <ImgUpload src="./images/account/Avatarupload.png"/>
                      <WrapBtnTitle>
                      <WrapButton>
                            <CustomButton variant="secondary" width="100%" bgcolor="#6C5DD3" color="#fff">
                                Upload New  
                            </CustomButton>
                            <CustomButton variant="secondary" width="100%" bgcolor="#E4E4E4" color="#11142D" ml="3">
                                Delete Avatar 
                            </CustomButton>
                        </WrapButton>   
                        <TitteDescription>Avatar help your teammates recognize you in Runtogether</TitteDescription>
                        </WrapBtnTitle> 
                      </Flex> */}
