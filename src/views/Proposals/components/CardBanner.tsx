            ...
            <Wrap>
                <Content>
                    <Flex>
                        ...
                        <TextContent>Users who own 1,000,000 RUN tokens have the right to propose to open the store owner.</TextContent>
                    </Flex>
                    <Flex>
                        <TextIcon>
                            <CsStarIcon fill='#FFFFFF'/>
                        </TextIcon>
                        <TextContent>When the pool reaches 2.5M amount of RUN tokens staked.   </TextContent>
                    </Flex>
                    <Flex>
                        <TextIcon>
                            <CsStarIcon fill='#FFFFFF'/>
                        </TextIcon>
                        <TextContent>RunTogether will open a shoe showroom, users will receive 30% of the store's sales profit and annual stake interest of 20%.</TextContent>
                    </Flex>
                </Content>
            </Wrap>
            <BtnContainer>  
