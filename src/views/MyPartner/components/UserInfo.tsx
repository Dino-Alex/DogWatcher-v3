...
import { Text, Flex, Button, useModal } from "@thaihuuluong/dogwatcher-uikit";
...
const UserInfo = () =>{
    ...
    const handleCopyLink = () => {
        navigator.clipboard.writeText(dataUser?.referral_code);
        ...
        <Container>
            <CustomCol>
                ...
                {/* <Flex mt="1rem">
                    ...
                    <CustomFlex>
                        <Text bold>Total rewards</Text>
                    </CustomFlex>
                    <CustomFlex justifyContent="flex-end">
                        <WrapCountRun>
                            <Text bold fontSize="30px" mr="10px">0.00</Text>
                            <ImgRun src="/images/coins/0xc643E83587818202E0fFf5eD96D10Abbc8Bb48e7.png"/>
                        </WrapCountRun>
                    </CustomFlex>
                        ...
                        <Flex width="100%" flexDirection="column" >
                            ...
                            {referralLink ?
                                ...
                                <>
                                    ...
                                    <ButtonCoppy onClick={handleCopyLink}>
                                        Coppy
                                    </ButtonCoppy>
                        ...
                        <Flex width="100%" flexDirection="column">
                            ...
                            {dataUser ?
                                <>
                                    ...
                                    <ButtonCoppy onClick={handleCopy}>
                                        Coppy
                                    </ButtonCoppy>
